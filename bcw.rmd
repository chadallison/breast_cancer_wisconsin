...
For these three metrics, model performance is roughly the same, with the only apparent different being the area under the ROC curve for the random forest model. I will do some hyperparameter tuning on the random forest and XGBoost models to see how that affects performance.
